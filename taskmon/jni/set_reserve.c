...
JNIEXPORT int JNICALL Java_com_example_taskmon_SetReserveActivity_setReserve(
...
JNIEXPORT int JNICALL Java_com_example_taskmon_CancelReserveActivity_cancelReserve(
